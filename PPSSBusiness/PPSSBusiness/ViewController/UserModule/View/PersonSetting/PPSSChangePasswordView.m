...
- (void)_layoutMainView {
    ...
    //密码
    PPSSLoginInputView *againPasswordField = [[PPSSLoginInputView alloc]initInputViewWithType:LoginInputType_Password icon:@"login_psd_icon" placeholder:@"请再次输入密码"];
    ...
    [loginBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(againPasswordField.mas_bottom).with.offset(72);
