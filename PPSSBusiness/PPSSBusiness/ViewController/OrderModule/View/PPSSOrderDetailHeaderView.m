...
- (void)_layoutMainView {
    ...
    UILabel *titleLbl = [LSKViewFactory initializeLableWithText:@"收款金额" font:14 textColor:COLOR_WHITECOLOR textAlignment:1 backgroundColor:ColorHexadecimal(Color_APP_MAIN, 1.0)];
