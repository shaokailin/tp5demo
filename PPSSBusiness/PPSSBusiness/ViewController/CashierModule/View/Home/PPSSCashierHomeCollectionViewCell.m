...
- (void)_latoutMainView {
    ...
    UILabel *titleLbl = [LSKViewFactory initializeLableWithText:nil font:14 textColor:[UIColor blackColor] textAlignment:0 backgroundColor:nil];
    _titleLbl = titleLbl;
    ...
    UILabel *detailLbl = [LSKViewFactory initializeLableWithText:nil font:12 textColor:ColorHexadecimal(Color_Text_CCCC, 1.0) textAlignment:0 backgroundColor:nil];
