...
static NSString * const kNavigation_BackImg = @"navigation_back";
...
- (void)addLeftNavigationButtonWithNornalImage:(NSString *)nornalImage
                                  seletedImage:(NSString *)seletedImage
                                        target:(id)target
                                        action:(SEL)action {
    UIBarButtonItem *tLeftButton = [UIBarButtonItem initBarButtonItemWithNornalImage:nornalImage seletedImage:seletedImage title:nil font:0 fontColor:nil target:target action:action];
...
- (void)addLeftNavigationButtonWithTitle:(NSString *)title target:(id)target action:(SEL)action {
    UIBarButtonItem *tLeftButton = [UIBarButtonItem initBarButtonItemWithNornalImage:nil seletedImage:nil title:title font:kNavigationBarButton_Font fontColor:ColorUtilsString(kNavigationBarButtonTitle_Color) target:target action:action];
    [self addNavigationLeftButton:tLeftButton];
}
...
- (void)addRightNavigationButtonWithNornalImage:(NSString *)nornalImage
                    seletedIamge:(NSString *)seletedImage
                          target:(id)target
                          action:(SEL)action {
    UIBarButtonItem *tRightButton = [UIBarButtonItem initBarButtonItemWithNornalImage:nornalImage seletedImage:seletedImage title:nil font:0 fontColor:nil target:target action:action];
...
- (void)addRightNavigationButtonWithTitle:(NSString *)title target:(id)target action:(SEL)action {
    UIBarButtonItem *tRightButton = [UIBarButtonItem initBarButtonItemWithNornalImage:nil seletedImage:nil title:title font:kNavigationBarButton_Font fontColor:ColorUtilsString(kNavigationBarButtonTitle_Color) target:target action:action];
    [self addNavigationRightButton:tRightButton];
}
#pragma mark - 通知
//添加监听
