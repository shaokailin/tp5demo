...
- (void)viewDidLoad {
    ...
    //设置tabbar的背景颜色
    [self setupTabBarBackgroundColor:ColorUtilsString(kTabBarBackground_Color)];
    //设置tabbar的标题 字体样式
    [self setupTabbarNornalTitleColor:ColorUtilsString(kTabBarTitleNornal_Color) tabbarSelectdTitleColor:ColorUtilsString(kTabBarTitleSelected_Color) tabbarTitleFont:kTabBarTitle_Font];
