...
- (UINavigationController *)initializeNavigationWithClass :(NSString *)className
    ...
    [self setupTabBarItemWithTabBarItem:navigation.tabBarItem title:tabbarTitle nornalImage:[nornalImage isHasValue] ? ImageNameInit(nornalImage) : nil seletedImage:[seletedImage isHasValue] ? ImageNameInit(seletedImage) : nil];
    return navigation;
}
