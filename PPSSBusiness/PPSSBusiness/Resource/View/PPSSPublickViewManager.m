...
+ (UILabel *)initLblForColor3333:(NSString *)text textAlignment:(NSTextAlignment)alignment {
    UILabel *lable = [LSKViewFactory initializeLableWithText:text font:14 textColor:ColorHexadecimal(Color_Text_3333, 1.0) textAlignment:alignment backgroundColor:nil];
    return lable;
}
+ (UILabel *)initLblForColor6666:(NSString *)text {
    UILabel *lable = [LSKViewFactory initializeLableWithText:text font:12 textColor:ColorHexadecimal(Color_Text_6666, 1.0) textAlignment:0 backgroundColor:nil];
    return lable;
}
+ (UILabel *)initLblForColor9999:(NSString *)text {
    UILabel *lable = [LSKViewFactory initializeLableWithText:text font:12 textColor:ColorHexadecimal(Color_Text_9999, 1.0) textAlignment:0 backgroundColor:nil];
    return lable;
}
+ (UILabel *)initLblForColorPink:(NSString *)text textAlignment:(NSTextAlignment)alignment {
    UILabel *lable = [LSKViewFactory initializeLableWithText:text font:12 textColor:ColorHexadecimal(Color_Text_Pink, 1.0) textAlignment:alignment backgroundColor:nil];
    return lable;
}
