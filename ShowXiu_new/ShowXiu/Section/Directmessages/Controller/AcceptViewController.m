...
@interface AcceptViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger page;
...
- (void)addUItableView{
    ...
    _tabelView.frame = CGRectMake(0, 1, kScreen_w, kScreen_h - 64);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    AcceptModel *model = _dataSuArray[indexPath.row];
