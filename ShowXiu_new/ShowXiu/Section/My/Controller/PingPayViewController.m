//
//  PingPayViewController.m
//  ShowXiu
//
//  Created by 上官昌璟 on 2017/6/16.
//  Copyright © 2017年 上官昌璟. All rights reserved.
//

#import "PingPayViewController.h"
#define PRODUCTID @"495100" //商品ID（请填写你商品的id）
@interface PingPayViewController ()<SKPaymentTransactionObserver, SKProductsRequestDelegate>
@property (strong, nonatomic) SKPayment *payment;
@property (strong, nonatomic) SKMutablePayment *g_payment;
@end

@implementation PingPayViewController
