...
@interface MyGuanViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MyGuanViewController
...
- (void)requestListData{
    ...
    NSString *URL = [NSString stringWithFormat:@"%@%@",AppURL,API_MY_MySubscribe];
