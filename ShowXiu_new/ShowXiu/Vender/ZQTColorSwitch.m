...
- (void)setupUI
{
    ...
    //打开时候的文字
    self.onBackLabel = [[UILabel alloc] initWithFrame:CGRectMake(3, 0,VW(self.onBackgroundView)-3 , VH(self.onBackgroundView))];
//    self.onBackLabel.backgroundColor = [UIColor redColor];
    self.onBackLabel.textColor = [UIColor whiteColor];
    self.onBackLabel.font = [UIFont systemFontOfSize:12];
    ...
    self.offBackLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, VW(self.offBackgroundView)-3, VH(self.offBackgroundView))];
    self.offBackLabel.font = [UIFont systemFontOfSize:12];
    self.offBackLabel.textAlignment = NSTextAlignmentRight;
    self.offBackLabel.textColor = [UIColor whiteColor];
