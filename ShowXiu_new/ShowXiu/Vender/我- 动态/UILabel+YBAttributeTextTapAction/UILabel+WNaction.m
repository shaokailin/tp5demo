...
//  UILabel+WNaction.m
//
//  Created by wangning on 16/7/1.
//  Copyright © 2016年 wangning. All rights reserved.
//

#import "UILabel+WNaction.h"
...
@implementation UILabel (WNaction)
...
- (void)wn_addAttributeTapActionWithStrings:(NSArray <NSString *> *)strings tapClicked:(void (^) (NSString *string , NSRange range , NSInteger index))tapClick
{
...
- (void)wn_addAttributeTapActionWithStrings:(NSArray <NSString *> *)strings
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    [self yb_getTapFrameWithTouchPoint:point result:^(NSString *string, NSRange range, NSInteger index) {
        ...
        if (weakSelf.delegate && [weakSelf.delegate respondsToSelector:@selector(wn_attributeTapReturnString:range:index:)]) {
            [weakSelf.delegate wn_attributeTapReturnString:string range:range index:index];
        }
