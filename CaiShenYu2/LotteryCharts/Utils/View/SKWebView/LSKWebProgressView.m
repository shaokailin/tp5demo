...
//    添加颜色的渐变
    ...
    //设置颜色的渐变过程
    NSMutableArray *gradientLayerColors = [NSMutableArray arrayWithArray:@[(__bridge id)(KColorUtilsString(kWebViewProgressStart_Color)).CGColor, (__bridge id)(KColorUtilsString(kWebViewProgressStart_Color)).CGColor]];
