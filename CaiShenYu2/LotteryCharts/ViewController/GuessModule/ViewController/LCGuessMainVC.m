...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LCGuessMainModel *listModel = [_viewModel.guessArray objectAtIndex:indexPath.section];
    LCGuessModel *model = [listModel.quiz_list objectAtIndex:indexPath.row];
    [cell setupContentWithPhoto:model.logo name:model.nickname userId:model.mch_no postId:model.quiz_id pushTime:model.create_time money:model.quiz_money count:model.hasCount openTime:model.update_time type:model.quiz_type tieziName:model.quiz_title];
    WS(ws)
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    LCGuessMainModel *model = [_viewModel.guessArray objectAtIndex:section];
    [headerView setupContentWithTime:model.end_time count:model.period_count];
