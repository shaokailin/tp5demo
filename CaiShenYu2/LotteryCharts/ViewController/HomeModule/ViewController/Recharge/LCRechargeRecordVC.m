//
//  LCRechargeRecordVC.m
//  LotteryCharts
//
//  Created by hsPlan on 2017/12/29.
...
@interface LCRechargeRecordVC ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation LCRechargeRecordVC
...
- (void)bindSignal {
    ...
    self.viewModel.year = _yearSelect;
    self.viewModel.mouth = _mouthSelect;
    [self.viewModel getRechargeRecord:NO];
}
- (void)endRefreshing {
...
- (void)pullDownRefresh {
    _viewModel.page = 0;
    [_viewModel getRechargeRecord:YES];
}
- (void)pullUpLoadMore {
    _viewModel.page += 1;
    [_viewModel getRechargeRecord:YES];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setupContentWithType:@"充值" time:model.create_time money:model.money];
    return cell;
}
#pragma mark 界面
