...
-(void)setupMenu{
    ...
    [btnPractice setBackgroundImage:[UIButton buttonImageFromColor:ColorWith(155  , 200, 151) withSize:CGSizeMake(kLeftViewSlideDepth, 50)] forState:UIControlStateSelected];
    btnPractice.tag=10;
    ...
    [btnHistory setBackgroundImage:[UIButton buttonImageFromColor:ColorWith(155  , 200, 151) withSize:CGSizeMake(kLeftViewSlideDepth, 50)] forState:UIControlStateSelected];
    btnHistory.tag=20;
    ...
    btnHorner.tag=30;
    [btnHorner setBackgroundImage:[UIButton buttonImageFromColor:ColorWith(155  , 200, 151) withSize:CGSizeMake(kLeftViewSlideDepth, 50)] forState:UIControlStateSelected];
    ...
    btnSetting.tag=40;
    [btnSetting setBackgroundImage:[UIButton buttonImageFromColor:ColorWith(155  , 200, 151) withSize:CGSizeMake(kLeftViewSlideDepth, 50)] forState:UIControlStateSelected];
